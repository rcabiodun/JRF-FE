                  ...
                  <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                    <div class="hero__caption">
                      <h1 data-animation="fadeInUp" data-delay=".6s">
                        <br /> Crowdfunding for Justice and Human Rights
                      </h1>
                      <p data-animation="fadeInUp" data-delay=".8s">
                        JusticeRightsFund is a global crowdfunding platform
                        dedicated to mobilizing funds, donations, and grants to
                        combat injustices affecting vulnerable populations.
                      </p>
                      <div class="hero__btn">
                        <a
